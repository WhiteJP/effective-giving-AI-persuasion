...
# Load all required packages and setup
...
4. Run this Quarto file with `quarto render main_report.qmd`

The analysis can be customized by modifying the YAML parameters at the top of this document.

## Alternative: R Markdown Version

For users who prefer R Markdown or don't have Quarto installed, a compatible version of this report is available as `main_report.Rmd` which uses child chunks for script execution.
