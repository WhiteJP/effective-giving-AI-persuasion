...
agreement_analysis_by_group(d_strat_agree_wide, group_var = "strategy")
...
d_strat_all_wide <- d |> 
  ...
  ## add new data, that we also want to control for, 
...
# update p values with q values for strategy coefficients
